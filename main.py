...
save_figs(examples, rm_results, "RM", 'RM', imgs_folder_addr)
save_figs(examples, dm_results, "DM", 'DM', imgs_folder_addr)
save_figs(examples, ed_results, "ED", 'ED', imgs_folder_addr)
save_figs(examples, ap_results, "AP", 'AP', imgs_folder_addr)
